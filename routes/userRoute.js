...
const { createUser, loginUser, updateProfile, getMyProfile, logoutUser, getAllUser, forgetPasswordMobile, resetpasswordMobile, } = require('../controllers/userController');
...
router.get('/student/all', isAuthenticated, isAdmin, getAllUser)
