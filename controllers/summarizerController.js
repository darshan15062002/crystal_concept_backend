...
exports.getSummaryGoogle = catchAsyncError((req, res) => {
    ...
    const prompt = `You are a friendly study assistant. Convert the following answer into a simple and easy-to-remember format so that children can understand and remember it well. Here is the text: ${pdfText}`;
